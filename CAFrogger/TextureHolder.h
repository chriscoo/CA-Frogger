...
namespace GEX
{
	enum class TextureID {AIRPLANE=0, RAPTOR, AVENGER, MISSLE, BULLET, DESERT, PARTICLE, TitleScreen, GexLogo, FireRate, FireSpread, HealthRefill, MissileRefill, Explosion, FinishLine, Background
	};
